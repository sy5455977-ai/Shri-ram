          ...
          {isRepairing ? (
            ...
            <>
              ...
              <button
                ...
                className="absolute bottom-8 left-1/2 -translate-x-1/2 w-20 h-20 rounded-full border-4 border-white flex items-center justify-center hover:scale-110 transition-transform z-30 focus-visible:ring-4 focus-visible:ring-white outline-none"
              >
            ...
            <div className="flex items-center space-x-2">
              ...
              {result && (
                <button
                  ...
                  className="ml-2 p-1.5 hover:bg-white/10 rounded-lg text-nexus-muted hover:text-white transition-all focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none"
                >
