...
export default function ChatInterface({ conversationId, onConversationCreated, performanceMode }: ChatInterfaceProps) {
  ...
  // Ref-syncing for stable callbacks
  ...
  const handleRegenerate = React.useCallback(async () => {
    ...
    // Efficient backward search to avoid array cloning and O(N) space
  ...
  }, []); // Stable callback via Ref-syncing
  ...
  // Keep handleSendRef updated for the stable handleRegenerate
  useEffect(() => {
