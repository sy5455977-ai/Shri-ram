        ...
        {hasMore && (
          <div className="flex justify-center mb-4">
            <button 
              ...
              className="text-[10px] font-black text-nexus-primary hover:text-white uppercase tracking-[0.3em] px-4 py-2 rounded-full border border-nexus-primary/20 hover:bg-nexus-primary/10 transition-all focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none"
        ...
        {conversationId && messages.length > 0 && (
          <div className="flex justify-end mb-4">
            <button 
              ...
              className="text-[10px] font-bold text-red-400/50 hover:text-red-400 uppercase tracking-widest transition-colors flex items-center space-x-1 focus-visible:ring-2 focus-visible:ring-red-400 outline-none rounded-sm"
            ...
            <div className="grid grid-cols-2 gap-3 mt-8">
              {['Generate a neon cat', 'Create a space video', 'Solve a math problem', 'Write some code'].map((suggestion) => (
                <button 
                  ...
                  className="p-4 glass rounded-2xl text-sm hover:bg-white/10 transition-all text-left focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none"
      ...
      <div className="p-4 bg-nexus-bg/80 backdrop-blur-md border-t border-white/10">
        {selectedImage && (
          <div className="mb-4 relative inline-block">
            ...
            <button 
              ...
              className="absolute -top-2 -right-2 bg-red-500 rounded-full p-1 text-white hover:bg-red-600 transition-colors focus-visible:ring-2 focus-visible:ring-white outline-none"
        ...
        <div className="flex items-center gap-2 glass p-2 rounded-2xl focus-within:ring-2 focus-within:ring-nexus-primary transition-all">
          ...
          <input
            ...
            className="flex-1 bg-transparent border-none focus:ring-0 outline-none text-nexus-text placeholder:text-nexus-muted px-2"
          ...
          <button
            ...
            className={cn(
              "p-3 rounded-xl nexus-gradient text-white transition-all focus-visible:ring-2 focus-visible:ring-white outline-none",
