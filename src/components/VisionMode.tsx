          ...
          {isRepairing ? (
            ...
            <>
              ...
              <button
                ...
                aria-label="Capture visual data"
                className="absolute bottom-8 left-1/2 -translate-x-1/2 w-20 h-20 rounded-full border-4 border-white flex items-center justify-center hover:scale-110 focus-visible:ring-4 focus-visible:ring-nexus-primary outline-none transition-all z-30"
              >
            ...
            <>
              ...
              <div className="absolute top-4 right-4 flex space-x-2">
                <button 
                  onClick={reset}
                  aria-label="Reset visual capture"
          ...
          <div className="p-4 border-b border-white/10 flex items-center justify-between bg-white/5">
            <div className="flex items-center space-x-2">
              ...
              {result && (
                <button
                  onClick={handleCopy}
                  aria-label={isCopied ? "Result copied to clipboard" : "Copy analysis result"}
                  className="ml-2 p-1.5 hover:bg-white/10 rounded-lg text-nexus-muted hover:text-white focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none transition-all"
                >
