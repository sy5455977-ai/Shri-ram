          ...
          {isRepairing ? (
            ...
            <>
              ...
              {!result && !isAnalyzing && (
                <button
                  onClick={runAnalysis}
                  aria-label="Process image with NEXUS"
          ...
          <div className="p-4 border-b border-white/10 flex items-center justify-between bg-white/5">
            ...
            <div className="flex items-center space-x-2">
              {result && !isAnalyzing && (
                <button
                  onClick={handleCopy}
                  className="p-1.5 hover:bg-white/10 rounded-lg text-nexus-muted hover:text-white transition-all flex items-center space-x-1 focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none"
              ...
              {isAnalyzing && (
                <div className="flex items-center space-x-2 text-nexus-primary text-sm">
                  ...
                  <span className="hidden sm:inline">NEXUS is scanning...</span>
                </div>
              )}
            </div>
          </div>
