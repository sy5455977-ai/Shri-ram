        ...
        <div className="flex flex-col glass rounded-3xl border-2 border-white/10 overflow-hidden">
          <div className="p-4 border-b border-white/10 flex items-center justify-between bg-white/5">
            ...
            {result && !isAnalyzing && (
              <button
                onClick={handleCopy}
                aria-label={isCopied ? "Result copied" : "Copy analysis result"}
                className="p-2 hover:bg-white/10 rounded-lg text-nexus-muted hover:text-white transition-all flex items-center space-x-1.5 focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none"
                title="Copy result"
              >
                {isCopied ? (
                  <>
