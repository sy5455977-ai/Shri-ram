            ...
            <>
              ...
              <div className="absolute top-4 right-4 flex space-x-2">
                <button 
                  ...
                  className="p-3 bg-nexus-bg/80 backdrop-blur-md rounded-xl text-white hover:bg-nexus-bg transition-all focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none"
                >
              ...
              {!result && !isAnalyzing && (
                <button
                  onClick={runAnalysis}
                  aria-label={`Start ${activeTask} analysis`}
                  className="absolute bottom-8 left-1/2 -translate-x-1/2 px-8 py-4 nexus-gradient rounded-2xl text-white font-bold nexus-glow flex items-center space-x-2 focus-visible:ring-2 focus-visible:ring-white outline-none transition-all"
                >
            ...
            <div className="flex items-center space-x-2">
              {result && !isAnalyzing && (
                <button
                  ...
                  className="p-2 hover:bg-white/10 rounded-lg text-nexus-muted hover:text-white transition-all focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none"
                >
