          ...
          {isRepairing ? (
            ...
            <>
              ...
              {!result && !isAnalyzing && (
                <button
                  onClick={runAnalysis}
                  className="absolute bottom-8 left-1/2 -translate-x-1/2 px-8 py-4 nexus-gradient rounded-2xl text-white font-bold nexus-glow flex items-center space-x-2 focus-visible:ring-4 focus-visible:ring-nexus-primary outline-none transition-all"
                >
