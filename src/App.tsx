  ...
  return (
    ...
    >
      ...
      <button 
        ...
        className="absolute right-2 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 p-1 hover:text-red-400 transition-all focus-visible:ring-2 focus-visible:ring-red-400 outline-none rounded-md"
      ...
      >
        <div className="p-6 flex items-center justify-between shrink-0">
          ...
          <button
            ...
            className="p-2 hover:bg-white/5 rounded-lg text-nexus-muted focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none transition-all"
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 rounded-2xl bg-white/5 border border-white/5">
                ...
                {systemHealth !== 'stable' && (
                  <button 
                    onClick={() => window.location.reload()}
                    className="p-1 hover:bg-white/10 rounded text-nexus-primary focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none transition-all"
