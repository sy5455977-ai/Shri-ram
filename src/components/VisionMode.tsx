          ...
          {(['analyze', 'math', 'ocr', 'summary'] as VisionTask[]).map((task) => (
            <button
              ...
              className={cn(
                ...
                activeTask === task ? "bg-nexus-primary text-nexus-bg shadow-[0_0_10px_rgba(0,242,255,0.3)]" : "text-nexus-muted hover:text-white",
          ...
          {isRepairing ? (
            ...
            <>
              ...
              <div className="absolute top-4 right-4 flex space-x-2">
                <button 
                  onClick={reset}
                  aria-label="Reset camera and discard image"
              ...
              {!result && !isAnalyzing && (
                <button
                  onClick={runAnalysis}
                  className="absolute bottom-8 left-1/2 -translate-x-1/2 px-8 py-4 nexus-gradient rounded-2xl text-white font-bold nexus-glow flex items-center space-x-2 outline-none focus-visible:ring-4 focus-visible:ring-white"
                >
              ...
              {result && !isAnalyzing && (
                <button
                  ...
                  className={cn(
                    ...
                    isCopied ? "bg-green-500/10 text-green-500" : "hover:bg-white/10 text-nexus-muted hover:text-white"
                  )}
                  aria-label={isCopied ? "Copied to clipboard" : "Copy analysis to clipboard"}
