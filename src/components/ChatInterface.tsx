...
export default function ChatInterface({ conversationId, onConversationCreated, performanceMode }: ChatInterfaceProps) {
  ...
  // Use a ref to track the latest messages state.
  // This allows callbacks like handleRegenerate to remain stable and avoid triggering
  // unnecessary re-renders of the MessageItem list when messages update.
  ...
  // Ref to hold the latest handleSend function to stabilize callbacks that depend on it.
  const handleSendRef = useRef<any>(null);

  /**
   * handleRegenerate is memoized and stable across message updates
   * by using messagesRef and handleSendRef.
   */
  ...
  // Keep handleSendRef in sync with the latest handleSend closure.
  useEffect(() => {
