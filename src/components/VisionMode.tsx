          ...
          {isRepairing ? (
            ...
            <>
              ...
              {!result && !isAnalyzing && (
                <button
                  onClick={runAnalysis}
                  className="absolute bottom-8 left-1/2 -translate-x-1/2 px-8 py-4 nexus-gradient rounded-2xl text-white font-bold nexus-glow flex items-center space-x-2 focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none"
                >
            ...
            <div className="flex items-center space-x-2">
              {result && (
                <button
                  ...
                  className="p-2 hover:bg-white/10 rounded-lg text-nexus-muted hover:text-white transition-all mr-2 focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none"
                >
