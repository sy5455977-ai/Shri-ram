...
export default function ChatInterface({ conversationId, onConversationCreated, performanceMode }: ChatInterfaceProps) {
  ...
  // Optimization: O(1) space complexity by avoiding array clone/reverse
  ...
  }, [input, selectedImage, conversationId, onConversationCreated, deepReasoning]);
        ...
        <AnimatePresence initial={false}>
          {messages.map((message, index) => (
            <MessageItem
              ...
              // Optimization: Only pass regenerate callback to the last message to keep props stable
