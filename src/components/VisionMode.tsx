        ...
        <div className="flex bg-white/5 p-1 rounded-xl border border-white/10">
          {(['analyze', 'math', 'ocr', 'summary'] as VisionTask[]).map((task) => (
            <button
              ...
              className={cn(
                "px-4 py-2 rounded-lg text-sm font-medium transition-all capitalize focus-visible:ring-2 focus-visible:ring-nexus-primary focus-visible:outline-none",
          ...
          {isRepairing ? (
            ...
            <>
              ...
              <button
                ...
                className="absolute bottom-8 left-1/2 -translate-x-1/2 w-20 h-20 rounded-full border-4 border-white flex items-center justify-center hover:scale-110 transition-transform z-30 focus-visible:ring-2 focus-visible:ring-nexus-primary focus-visible:outline-none"
              >
            ...
            <>
              ...
              <div className="absolute top-4 right-4 flex space-x-2">
                <button 
                  ...
                  className="p-3 bg-nexus-bg/80 backdrop-blur-md rounded-xl text-white hover:bg-nexus-bg transition-colors focus-visible:ring-2 focus-visible:ring-nexus-primary focus-visible:outline-none"
                >
              ...
              {!result && !isAnalyzing && (
                <button
                  onClick={runAnalysis}
                  aria-label="Process with NEXUS"
                  className="absolute bottom-8 left-1/2 -translate-x-1/2 px-8 py-4 nexus-gradient rounded-2xl text-white font-bold nexus-glow flex items-center space-x-2 focus-visible:ring-2 focus-visible:ring-nexus-primary focus-visible:outline-none"
                >
          ...
          <div className="p-4 border-b border-white/10 flex items-center justify-between bg-white/5">
            <div className="flex items-center space-x-2">
              ...
              {result && !isAnalyzing && (
                <button
                  onClick={handleCopy}
                  aria-label={isCopied ? "Copied" : "Copy analysis result"}
                  className="p-1.5 hover:bg-white/10 rounded-lg text-nexus-muted hover:text-white transition-all focus-visible:ring-2 focus-visible:ring-nexus-primary focus-visible:outline-none"
                >
