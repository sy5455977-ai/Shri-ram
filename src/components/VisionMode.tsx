            ...
            <div className="flex items-center space-x-4">
              ...
              {result && !isAnalyzing && (
                <button
                  ...
                  className="p-1.5 hover:bg-white/10 rounded-lg text-nexus-muted hover:text-white transition-all focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none flex items-center space-x-1.5"
                >
                  {isCopied ? (
                    <>
