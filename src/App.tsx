  ...
  return (
    ...
    >
      ...
      <button 
        ...
        className="absolute right-2 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 p-1 hover:text-red-400 transition-all focus-visible:ring-2 focus-visible:ring-red-400 outline-none"
    ...
    <div className="flex h-screen bg-nexus-bg text-nexus-text overflow-hidden font-sans selection:bg-nexus-primary/30">
      ...
      >
        <div className="p-6 flex items-center justify-between shrink-0">
          ...
          <button onClick={() => setIsSidebarOpen(false)} className="p-2 hover:bg-white/5 rounded-lg text-nexus-muted focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none" aria-label="Close sidebar">
            <X className="w-5 h-5" />
          </button>
        </div>
          ...
          <div className="flex items-center justify-between px-2 mb-2">
            ...
            {conversations.length > 0 && (
              <button 
                ...
                className="text-[10px] font-bold text-red-400/50 hover:text-red-400 uppercase tracking-widest transition-colors focus-visible:ring-2 focus-visible:ring-red-400 outline-none rounded"
      ...
      <main className="flex-1 flex flex-col relative min-w-0">
        ...
        <header className="h-20 border-b border-white/10 flex items-center justify-between px-4 md:px-8 bg-nexus-bg/50 backdrop-blur-md z-40">
          <div className="flex items-center space-x-3 md:space-x-4">
            {!isSidebarOpen && (
              <div className="flex items-center space-x-2">
                <button onClick={() => setIsSidebarOpen(true)} className="p-2 hover:bg-white/5 rounded-lg text-nexus-muted focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none" aria-label="Open sidebar">
