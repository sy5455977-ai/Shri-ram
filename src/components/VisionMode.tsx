          ...
          {isRepairing ? (
            ...
            <>
              ...
              {!result && !isAnalyzing && (
                <button
                  onClick={runAnalysis}
                  aria-label="Process analysis with NEXUS"
          ...
          <div className="p-4 border-b border-white/10 flex items-center justify-between bg-white/5">
            ...
            {result && !isAnalyzing && (
              <button
                ...
                className="p-2 hover:bg-white/10 rounded-lg text-nexus-muted hover:text-white transition-all flex items-center space-x-1 focus-visible:ring-2 focus-visible:ring-nexus-primary outline-none"
              >
                {isCopied ? (
                  <>
                    <Check className="w-4 h-4 text-green-400" />
                    <span className="text-[10px] font-bold uppercase tracking-widest text-green-400">Copied</span>
                  </>
                ) : (
                  <>
